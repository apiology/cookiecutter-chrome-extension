...
See [docs/SYNCING_BOILERPLATE.md](docs/SYNCING_BOILERPLATE.md). Interpret hierarchy at **this** tier (`cookiecutter-chrome-extension`, Chrome Extension) using `.cursor/rules/template-hierarchy.mdc` when present.
